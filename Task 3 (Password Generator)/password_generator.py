...
t=tkinter.Label(f1,text="Password Length",fg="black",bg="orange",font=("Cascadia Code ExtraLight",12,"bold"))          
...
b=tkinter.Button(f3,text="Generate",bg="black",fg="orange",font=("Cascadia Code ExtraLight",9,"bold"),command=click)     
b.grid(row=0,column=0,padx=5)
b1=tkinter.Button(f3,text="Quit",bg="black",fg="orange",font=("Cascadia Code ExtraLight",9,"bold"),command=quit)         
